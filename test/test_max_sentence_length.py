...
- 배치 크기: 1 ~ 16
- 문장 길이: 매우 짧은 문장(~5자) ~ 매우 긴 문장(~1000자+)
- 측정 항목: RTF, TTFB
...
# ── 테스트 문장 정의 ────────────────────────────────────────────────────────
# 다양한 길이의 테스트 문장 (매우 짧은 → 매우 긴)
# 각 튜플: (라벨, 텍스트)
_BASE_SENTENCE = "안녕하세요, 이천이십육년 사월 삼일 목요일 저녁, 여러분의 곁을 지키는 AI DJ 멜론 허니듀입니다."  # ~50자
...
TEST_SENTENCES: list[tuple[str, str]] = [
    ...
    # 짧은 문장
    ("len_020", "오늘 하루도 수고 많으셨습니다."),
    ("len_030", "오늘 하루도 수고 많으셨습니다. 편안한 저녁 되세요."),

    # 일반적인 길이
    ("len_050", _BASE_SENTENCE),
    ("len_070", "창밖으로 하나둘 불이 켜지는 도시의 야경을 보고 있으니, 문득 여러분의 마음에도 따뜻한 위로가 필요하진 않을까 하는 생각이 듭니다."),
    ("len_100", (
    ...
    ("len_500", (
        ...
        "차가운 사월의 공기를 녹여줄 수 있는, 포근한 담요 같은 노래들을 함께 들으려 합니다. "
        "잠시 일상의 소음은 뒤로하고, 지금 이 순간 흐르는 선율에 오롯이 몸을 맡겨보시는 건 어떨까요? "
        "오늘 소개해 드릴 첫 번째 곡은 잔잔한 피아노 선율로 시작해 서서히 따뜻한 현악기가 더해지는 곡인데요, "
        "마치 겨울밤 창가에 앉아 눈이 내리는 풍경을 바라보는 듯한 느낌을 줍니다. "
        "이 곡을 들으시면서 오늘 하루 동안 쌓인 피로와 걱정들을 잠시 내려놓으시길 바랍니다. "
        "음악이 흐르는 동안만큼은 모든 것이 괜찮다는 것을 느끼실 수 있을 거예요."
    )),
    ("len_700", (
        "안녕하세요, 이천이십육년 사월 삼일 목요일 저녁, 여러분의 곁을 지키는 AI DJ 멜론 허니듀입니다. "
        "어느덧 한 주를 마무리하는 시간인데, 다들 오늘 하루는 어떻게 보내셨나요? "
        ...
        "이 곡을 들으시면서 오늘 하루 동안 쌓인 피로와 걱정들을 잠시 내려놓으시길 바랍니다. "
        "음악이 흐르는 동안만큼은 모든 것이 괜찮다는 것을 느끼실 수 있을 거예요. "
        "두 번째 곡은 어쿠스틱 기타와 부드러운 보컬이 어우러진 포크 발라드입니다. "
        "가사 하나하나가 마치 오래된 친구가 건네는 위로의 말처럼 따뜻하고 진실되게 다가오는데요, "
        "이 노래를 듣고 있으면 어딘가에서 누군가가 나를 응원하고 있다는 느낌이 들어 마음이 한결 가벼워집니다. "
        "세 번째 곡은 재즈 피아노 트리오의 연주곡으로, 즉흥적인 멜로디 속에서도 일정한 리듬감이 느껴져 편안한 분위기를 자아냅니다."
    )),
    ("len_1000", (
        "안녕하세요, 이천이십육년 사월 삼일 목요일 저녁, 여러분의 곁을 지키는 AI DJ 멜론 허니듀입니다. "
        "어느덧 한 주를 마무리하는 시간인데, 다들 오늘 하루는 어떻게 보내셨나요? "
        ...
        "이 노래를 듣고 있으면 어딘가에서 누군가가 나를 응원하고 있다는 느낌이 들어 마음이 한결 가벼워집니다. "
        "세 번째 곡은 재즈 피아노 트리오의 연주곡으로, 즉흥적인 멜로디 속에서도 일정한 리듬감이 느껴져 편안한 분위기를 자아냅니다. "
        "네 번째 곡은 첼로와 피아노의 듀엣으로, 깊고 풍부한 첼로의 음색이 피아노의 맑은 음과 어우러져 마치 깊은 숲속을 거니는 듯한 평온함을 선사합니다. "
        "다섯 번째 곡은 일렉트로닉 앰비언트 장르의 곡으로, 은은한 신시사이저 패드와 자연의 소리가 조화를 이루며 명상적인 분위기를 만들어 냅니다. "
        "여섯 번째 곡은 클래식 현악 사중주의 느린 악장으로, 바이올린과 비올라, 첼로가 서로 대화하듯 엮어내는 선율이 가슴 깊이 울려 퍼집니다. "
        "이렇게 오늘 준비한 여섯 곡의 음악이 여러분의 저녁 시간을 조금이나마 따뜻하게 채워드렸으면 좋겠습니다."
    )),
]
